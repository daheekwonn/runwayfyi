...
// swap with sanityFetch(articlesQuery) when CMS is live
const ARTICLES: Article[] = [
  ...
  },
  {
    ...
    excerpt: '34 collections. +180% search interest. The deep red that became the unavoidable colour signal of FW26.',
    date: 'Feb 28, 2026',
    img: 'https://images.unsplash.com/photo-1536183922588-166604504d5e?w=900&q=80',
    score: 71,
  },
  {
    id: 7,
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing:border-box; margin:0; padding:0; }
        ...
        .lead-img img { width:100%; aspect-ratio:2/3; object-fit:cover; object-position:top center; filter:grayscale(8%) brightness(0.9); display:block; transition:transform .55s ease; }
        ...
        .side-img img { width:100%; aspect-ratio:2/3; object-fit:cover; object-position:top center; filter:grayscale(8%) brightness(0.9); display:block; transition:transform .5s ease; }
        ...
        .a-row-body { padding:36px 44px 36px 52px; display:flex; flex-direction:column; justify-content:space-between; border-right:1px solid var(--bd); }
        ...
        .a-row-title { font-family:var(--f-display); font-size:clamp(22px,2.2vw,32px); font-weight:700; letter-spacing:-0.02em; line-height:1.06; text-transform:lowercase; color:var(--ink); margin-bottom:12px; }
        .a-row-excerpt { font-family:var(--f-body); font-size:14px; line-height:1.75; color:var(--mid); display:-webkit-box; -webkit-line-clamp:3; -webkit-box-orient:vertical; overflow:hidden; flex:1; }
        .a-row-foot { display:flex; align-items:center; gap:14px; margin-top:24px; padding-top:18px; border-top:1px solid var(--bd); }
        ...
        .g-card-img img { width:100%; aspect-ratio:2/3; object-fit:cover; object-position:top center; filter:grayscale(8%) brightness(0.9); display:block; transition:transform .5s ease; }
              ...
              <div className="lead-main">
                <a href={`/analysis/${hero.id}`} className="lead-main-a">
                  ...
                  <div className="lead-body">
                    <div className="lead-score">Score {hero.score}</div>
                  ...
                  <a key={a.id} href={`/analysis/${a.id}`} className="side-a">
                    ...
                    <div className="side-body">
                      ...
                      <div className="side-foot">
                        ...
                        <span className="side-score">Score {a.score}</span>
                      </div>
                    </div>
                  </a>
                ))}
