    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing:border-box; margin:0; padding:0; }
        ...
        .lead { display:grid; grid-template-columns:55fr 45fr; border-bottom:1px solid var(--bd); align-items:stretch; }
        .lead-main { border-right:1px solid var(--bd); display:flex; flex-direction:column; }
        .lead-main-a { display:block; text-decoration:none; color:inherit; transition:opacity .18s; flex:1; }
        .lead-main-a:hover { opacity:.84; }
        .lead-img { overflow:hidden; aspect-ratio:4/5; width:100%; max-height:340px; }
        ...
        .side-img { overflow:hidden; aspect-ratio:3/2; width:100%; max-height:160px; flex-shrink:0; }
